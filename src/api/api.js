...
import {
  systemGetTotalUsersUrl,
  systemAddOneUserUrl,
  systemGetTotalRoleTeamUrl,
  officeGetManagerClassUrl,
  officeGetStuByCostFreeUrl,
  officeGetStuBySleepFreeUrl,
  officeGetExamResultUrl,
  officeGetStuByScoreFreeUrl,
  officeGetStuByCostFixedUrl,
  officeGetStuBySleepFixedUrl,
  officeGetStuByScoreFixedUrl,
  systemGetTotalUserTeamUrl,
  systemGetOneUserUrl,
  systemSetOneUserUrl,
  systemDelOneUserUrl,
  systemAddOneUserTeamUrl,
  systemDelOneUserTeamUrl,
  systemSetOneUserTeamUrl,
  systemGetOneUserTeamUrl,
  systemAddOneRoleTeamUrl,
  systemDelOneRoleTeamUrl,
  systemSetOneRoleTeamUrl,
  systemGetOneRoleTeamUrl,
  officeSuggestionUrl,
  officeDataExporeUrl,
  indexMajorFocusTableUrl,
  indexMajorFocusGrowLineUrl,
  indexMajorFocusGrowBarUrl,
  personGetBasicUrl,
  personGetEventInfoUrl,
  personGetPersonScoreInfoUrl,
  personGetPersonTripInfoUrl,
  personGetPersonCardfInfoUrl,
  personAddEventInfoUrl,
  personAddFocusInfoUrl,
  personCancelFocusInfoUrl,
  loginUrl,
  officeDataFilterUrl,
  loginGetUserRoleUrl,
  loginChangeUserPwdUrl,
  loginExitLoginUrl
} from "@/api/httpapi"
...
export const GetManagerClass = (userid, sessionid) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetManagerClassUrl, {"userId": userid, "sessionId": sessionid}).then(
      (res) => {
        resolve(res['data'])
      }
    )
...
export const GetStuByCostFree = (userid, returnKind, stuRange, dataRange, moneyRange, countKind) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetStuByCostFreeUrl, {
      "userId": userid,
...
export const GetStuBySleepFree = (userid, returnKind, stuRange, dataRange, countKind, appearTimes) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetStuBySleepFreeUrl, {
      "userId": userid,
      "returnKind": returnKind,
      'stuRange': stuRange,
      'dateRange': dataRange,
...
export const GetExamResult = (userid, returnKind, stuRange, courseRange) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetExamResultUrl, {
      "userId": userid,
      "returnKind": returnKind,
      'stuRange': stuRange,
...
export const GetStuByScoreFree = (userid, returnKind, stuRange, courseRange, countKind, countRange) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetStuByScoreFreeUrl, {
      "userId": userid,
      "returnKind": returnKind,
      'stuRange': stuRange,
      'courseRange': courseRange,
...
export const GetStuByCostFixed = (userid, returnKind, sessionid, queryKind) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetStuByCostFixedUrl, {
      "userId": userid,
      "returnKind": returnKind,
      'sessionId': sessionid,
      'queryKind': queryKind,
...
export const GetStuBySleepFixed = (userid, returnKind, sessionid, queryKind) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetStuBySleepFixedUrl, {
      "userId": userid,
      "returnKind": returnKind,
      'sessionId': sessionid,
      'queryKind': queryKind,
...
export const GetStuByScoreFixed = (userid, returnKind, sessionid, queryKind) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeGetStuByScoreFixedUrl, {
      "userId": userid,
      "returnKind": returnKind,
      'sessionId': sessionid,
      'queryKind': queryKind,
...
export const ChangeUserPwd = (userid, oldpwd, newpwd1, newpwd2) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(loginChangeUserPwdUrl, {
      userId: userid,
      oldpwd: oldpwd,
      newpwd1: newpwd1,
      newpwd2: newpwd2
...
export const getPersonBasicInfo = (userid, stuid) => {
  ...
  var p = new Promise(function (resolve, reject) {
    myAxios.post(personGetBasicUrl, {
      userId: userid,
      stuId: stuid
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const getPersonScoreInfo = (userid, stuid) => {
  ...
  var p = new Promise(function (resolve, reject) {
    myAxios.post(personGetPersonScoreInfoUrl, {
      userId: userid,
      stuId: stuid
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const getPersonTripInfo = (userid, stuid) => {
  ...
  var p = new Promise(function (resolve, reject) {
    myAxios.post(personGetPersonTripInfoUrl, {
      userId: userid,
      stuId: stuid
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const getPersonCardInfo = (userid, stuid) => {
  ...
  var p = new Promise(function (resolve, reject) {
    myAxios.post(personGetPersonCardfInfoUrl, {
      userId: userid,
      stuId: stuid
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const getPersonEventInfo = (userid, stuid) => {
  ...
  var p = new Promise(function (resolve, reject) {
    myAxios.post(personGetEventInfoUrl, {
      userId: userid,
      stuId: stuid
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const systemGetOneUserTeam = (userid, userTeamName) => {
  ...
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemGetOneUserTeamUrl, {
      userId: userid,
...
export const systemSetOneUserTeam = (userid, userTeamName, data) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemSetOneUserTeamUrl, {
      userId: userid,
      userTeamName: userTeamName,
      data: data
    }, {headers: {'Content-Type': 'application/json'}}).then(
...
export const systemAddOneUserTeam = (userid, data) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemAddOneUserTeamUrl, {
      userId: userid,
      data: data
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const systemDelOneUserTeam = (userid, userTeamName) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemDelOneUserTeamUrl, {
      userId: userid,
      userTeamName: userTeamName
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const systemGetOneRoleTeam = (userid, roleTeamName) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemGetOneRoleTeamUrl, {
      userId: userid,
      roleTeamName: roleTeamName
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
        resolve(respone['data'])
      }
...
export const systemDelOneRoleTeam = (userid, userRoleName) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemDelOneRoleTeamUrl, {
      userId: userid,
      roleTeamName: userRoleName
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
        resolve(respone['data'])
      }
...
export const systemSetOneRoleTeam = (userid, roleTeamName, data) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemSetOneRoleTeamUrl, {
      userId: userid,
      roleTeamName: roleTeamName,
      data: data
    }, {headers: {'Content-Type': 'application/json'}}).then(
...
export const systemAddOneRoleTeam = (userid, data) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemAddOneRoleTeamUrl, {
      userId: userid,
      data: data
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const systemGetOneUser = (userid, userName) => {
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemGetOneUserUrl, {
      userId: userid,
      userName: userName
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const systemDelOneUser = (userid, userName) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemDelOneUserUrl, {
      userId: userid,
      userName: userName
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const systemSetOneUser = (userid, name, data) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemSetOneUserUrl, {
      userId: userid,
      name: name,
      data: data
    }, {headers: {'Content-Type': 'application/json'}}).then(
...
export const systemAddOneUser = (userid, data) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(systemAddOneUserUrl, {
      userId: userid,
      data: data
    }, {headers: {'Content-Type': 'application/json'}}).then(
      (respone) => {
...
export const officeSuggestions = (userid, content, start) => {
  ...
  */
  var p = new Promise(function (resolve, reject) {
    myAxios.post(officeSuggestionUrl, {
      userId: userid,
      content: content,
      start: start
    }, {headers: {'Content-Type': 'application/json'}}).then(
...
export const dataGetModeBasic = () => {
  return {
    ...
    "公寓号": "apartmentNumber",
    "寝室号": "dormitoryNumber",
    "毕业高中": "graduatedHighSchool",
    "学生手机号": "stuMobileNumber",
    "家庭地址": "homeAddress",
    "父亲姓名": "fatherName",
    "父亲工作单位": "fatherWorkUnit",
    "父亲联系方式": "fatherMobileNumber",
    "母亲姓名": "motherName",
    "母亲工作单位": "motherWorkUnit",
    "母亲联系方式": "motherMobileNumber"
  }
}
...
export const dataGetModeScore = () => {
  ...
  return {
    ...
    "学号": "stuID",
    "初试成绩": "initialScore",
    "补考成绩(没有不填写)": "makeUpScore",
    "考试时间(格式如:2017-01-01)": "examDate",
    "是否重修(是或者否)": "repairOrNot"
  }
}
