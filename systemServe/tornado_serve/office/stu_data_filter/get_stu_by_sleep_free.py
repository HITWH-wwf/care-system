...
class GetStuBySleepFree():
    def entry(self,receiveRequest,waitFilteStuId=None):
        ...
        appearTimes=self.requestData['sleep']['appearTimes']
        ...
        if stuFlag['status'] == 0:
            return stuFlag
        return self.getStuResultByCondition(self.requestData['returnKind'],self.requestData['sleep']['countKind'],
    ...
    def getStuResultByCondition(self,returnKind,countKind,startDate,endDate,minTimes,maxTimes):
        ...
        for stu in self.selectStuIds:
            ...
            if times>=minTimes and times<=maxTimes:
                if returnKind=='stuRecord' and self.waitFilteStuId is None:
        ...
        if self.waitFilteStuId is not None:
            ...
            if returnKind == 'stuList':
                ...
                for stu in resultStu.keys():
                    stuSleepRecord.loc[stuSleepRecord[stuSleepRecord['stuID'] == stu].index, ('stuName')] = \
